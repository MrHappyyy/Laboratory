...
public class StatisticsEntity {
    ...
    private final static String nameProductTable = "StatisticsEntity";
    private final static String CREATE_STATISTICS_TABLE = "create table if not exists " + nameProductTable +
            "('id' integer primary key autoincrement," +
            " 'name' text, 'group' text, 'subGroup' text," +
